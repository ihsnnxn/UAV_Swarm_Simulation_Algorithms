function floyd_warshallUI()
    ...
    %% === GUI SETUP ===
    fig = figure('Name','Floyd-Warshall Drone UI', ...
                 'NumberTitle','off', ...
    ...
    title(ax,'Floyd-Warshall Simulation','FontSize',15);
    ...
    instructionText = uicontrol(fig,'Style','text',...
        ...
        '1) Click "Add Nodes" then click points and press Enter.' newline ...
        '2) Click "Define Edges" to connect nodes.' newline ...
        '3) Select start/end nodes and click "Start Simulation".' newline ...
        '4) Use "Move Node" or "Delete Node" to modify network.' newline ...
        '5) Press "Reset" to return to default network.'], ...
        'Units','normalized','Position',[0.8 0.09 0.15 0.9],...
